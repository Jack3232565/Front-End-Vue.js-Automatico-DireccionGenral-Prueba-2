...
export default {
  ...
  data() {
    return {
      ...
      idInsertado: "",
      solicitudes: [],
      api: "https://proyectohospital2024.onrender.com/personal_medico/",
  ...
  methods: {
    extractFormPersona() {
      ...
      const apiUrl = "https://proyectohospital2024.onrender.com/person/";
    ...
    extractFormPersonalMedico() {
      ...
      const apiUrl = isUpdating
        ? `https://proyectohospital2024.onrender.com/personal_medico/${this.formPersonalMedico.Persona_ID}`
        : "https://proyectohospital2024.onrender.com/personal_medico/";
    ...
    deletePersonal(personaId) {
      ...
      const apiUrl = `https://proyectohospital2024.onrender.com/personal_medico/${personaId}`;

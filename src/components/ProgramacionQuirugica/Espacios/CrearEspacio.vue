<template>
  <div class="bg-gray-300 rounded-2xl p-10 flex flex-col items-center max-w-4xl w-full mx-auto">
    <h1 class="font-bold text-3xl text-[#0F6466] mb-4">Crear Espacio</h1>
    <form @submit.prevent="crearEspacio" class="w-full">
      ...
      <div class="mb-4">
        ...
        <input v-model="espacio.Departamento_ID" type="number" class="p-2 rounded-xl border border-gray-300 w-full" id="departamento" required>
      </div>
      <div class="mb-4">
      ...
      <div class="flex justify-end space-x-4">
        <button type="submit" class="bg-green-500 text-white py-2 px-4 rounded-xl hover:scale-105 duration-300 hover:bg-green-600">Crear</button>
...
export default {
  ...
  methods: {
    crearEspacio() {
      axios.post('https://renderbackend-dwke.onrender.com/espacios/', this.espacio, {
        headers: {

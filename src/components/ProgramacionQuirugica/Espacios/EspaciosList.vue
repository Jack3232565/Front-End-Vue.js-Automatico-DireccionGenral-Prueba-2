<template>
    <div class="container">
      <h1 class="text-center">Lista de Espacios</h1>
      <button @click="irACrearEspacio" class="btn btn-primary mb-3">Crear Espacio</button>
      <table class="table table-bordered">
        ...
        <tbody>
          <tr v-for="espacio in espacios" :key="espacio.ID">
            ...
            <td>
              <button @click="editarEspacio(espacio.ID)" class="btn btn-warning">Editar</button>
              <button @click="eliminarEspacio(espacio.ID)" class="btn btn-danger">Eliminar</button>
            </td>
          </tr>
        </tbody>
      </table>

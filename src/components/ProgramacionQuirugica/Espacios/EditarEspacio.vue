<template>
    <div class="container">
      <h1 class="text-center">Editar Espacio</h1>
      <form @submit.prevent="editarEspacio">
        ...
        <div class="mb-3">
          ...
          <input v-model.number="espacio.Departamento_ID" type="number" class="form-control" id="departamento" required>
        </div>
        <div class="mb-3">
